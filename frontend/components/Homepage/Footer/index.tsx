    ...
    <div className="bg-black px-[2rem] md:px-[6rem] xl:px-[15vw] py-[5rem]">
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-[2rem] pb-8">
        <div className="col1 col-span-2 md:col-span-1 lg:w-[90%] lg:col-span-1">
          <h1 className="font-heading text-3xl font-bold uppercase text-blurple leading-8">
            Imagine a place
          </h1>
          <div className="countyLag flex items-center justify-start gap-3 mt-6 cursor-pointer">
            ...
            <div className="languages text-white text-sm">
          ...
          <div className="socialIcons mt-6">
            <TwitterIcon
              fontSize="medium"
              className="text-slate-50 mr-4 cursor-pointer"
            />
            <InstagramIcon
              fontSize="medium"
              className="text-slate-50 mr-4 cursor-pointer"
        ...
        <div className="lg:ml-[8rem] md:col-start-2 flex flex-col">
          ...
          <p className="font-body text-white my-2 hover:underline underline-offset-4 cursor-pointer">
            Download
          </p>
          <p className="font-body text-white my-2 hover:underline underline-offset-4 cursor-pointer">
            Nitro
      ...
      <div className="flex items-center justify-between border-t-[1px] border-t-blurple pt-8">
        ...
        <div className="btn">
          <button className="text-center sm:py-[0.4rem] sm:px-4 py-[0.8vw] px-[4vw] capitalize font-medium text-sm text-white rounded-3xl bg-blurple hover:bg-[#717dff] hover:shadow-xl transition-all duration-200 ease-in">
            {userLoggedIn ? (
              <Link href="/channels@me">Open Discord</Link>
            ) : (
