        ...
        <Image src={logo} alt="Discord Logo" width={124} height={24} className="cursor-pointer" />
          <div className='lg:block hidden'>
            <ul className='flex items-center justify-center'>
              <li className='capitalize mr-8 text-white font-[640] text-[0.95rem] cursor-pointer hover:underline'>download</li>
              <li className='capitalize mr-8 text-white font-[640] text-[0.95rem] cursor-pointer hover:underline'>nitro</li>
              <li className='capitalize mr-8 text-white font-[640] text-[0.95rem] cursor-pointer hover:underline'>safety</li>
              <li className='capitalize mr-8 text-white font-[640] text-[0.95rem] cursor-pointer hover:underline'>support</li>
              <li className='capitalize mr-8 text-white font-[640] text-[0.95rem] cursor-pointer hover:underline'>blog</li>
              ...
              <div className={`${displayNav === true ? `absolute top-0 right-0 rounded-l-lg z-40 w-[90%] md:w-[40%] max-w-md min-h-full bg-white` : `hidden`}`}>
                  ...
                  <div className="content p-1 pl-7 w-full">
                    <ul className='w-[90%] border-t-[0.1rem]'>
                      ...
                      <li className="mt-[0.05rem] px-4 py-[0.5rem] w-full cursor-pointer rounded-lg font-normal text-md text-gray-700 capitalize active:text-[#00B5F4] active:bg-[#0000000a]">
                        <span className='hover:underline mr-[0.25rem]'>safety <ArrowForwardIosIcon fontSize="small" /></span>
                      </li>
                      <li className="mt-[0.05rem] px-4 py-[0.5rem] w-full cursor-pointer rounded-lg font-normal text-md text-gray-700 capitalize active:text-[#00B5F4] active:bg-[#0000000a]">
                        <span className='hover:underline mr-[0.25rem]'>mod academy <ArrowForwardIosIcon fontSize="small" /></span>
                      </li>
                      <li className="mt-[0.05rem] px-4 py-[0.5rem] w-full cursor-pointer rounded-lg font-normal text-md text-gray-700 capitalize active:text-[#00B5F4] active:bg-[#0000000a]">
